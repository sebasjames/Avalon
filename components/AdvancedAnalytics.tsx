...
export const AdvancedAnalytics: React.FC = () => {
    ...
    const SECTIONS = [
        ...
        { id: 3, title: "Diagnóstico de Pronósticos", icon: Target, desc: "MAPE, Sesgo, Intervalos de Confianza, Backtesting" },
    ...
    const renderContent = () => {
        switch(activeSection) {
            ...
            case 3: // Forecast Diagnostics
                 return (
                    <div className="space-y-6 animate-in fade-in duration-500">
                        <SectionHeader icon={Target} title="Diagnóstico de Pronósticos" subtitle="Auditoría forense de la precisión de los modelos predictivos." />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-4">
                                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                                    <div className="text-xs text-slate-500 uppercase font-bold">Desviación del Pronóstico</div>
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                                ...
                                <ResponsiveContainer width="100%" height={300}>
                                    <BarChart data={REVENUE_WATERFALL}>
                                        ...
                                        <YAxis />
                                        <Tooltip cursor={{fill: 'transparent'}} formatter={(value: number) => `$${Math.abs(value).toLocaleString('es-CO')} COP`} />
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        {FRICTION_CLIENTS.map((client, idx) => (
                                            <tr key={idx}>
                                                ...
                                                <td className="px-4 py-3 text-right text-rose-600 font-bold">${client.lost.toLocaleString('es-CO')} COP</td>
                                                <td className="px-4 py-3 text-right text-amber-600 font-medium">${client.blocked.toLocaleString('es-CO')} COP</td>
                    ...
                    <div className="space-y-6 animate-in fade-in duration-500">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                                ...
                                <p className="text-xs text-slate-500 mb-4">Degradación de la precisión del modelo de Pronóstico con el tiempo.</p>
                            ...
                            <div className="space-y-4">
                                ...
                                <InsightCard 
                                    ...
                                    insight="El modelo de Pronóstico ha caído por debajo del 90% de precisión en la Semana 6. Se ha programado un re-entrenamiento automático para esta noche."
                                    type="risk"
                                />
                            </div>
                        </div>
            ...
            case 14: // Advanced Crosses
                const RADAR_DATA = [
                  ...
                  { subject: 'Precisión Pronóstico', A: 99, B: 100, fullMark: 150 },
                                ...
                                <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                                    ...
                                    <ul className="space-y-3 text-sm">
                                        <li className="flex justify-between items-center p-2 bg-white rounded shadow-sm border-l-4 border-emerald-500">
                                            <span>Error de Pronóstico (Bajo) × Margen (Alto)</span>
