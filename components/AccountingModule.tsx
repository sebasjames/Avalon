                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 font-medium">
                            ...
                            {activeTab === 'activos_liquidez' && 'Activos y Liquidez (Cartera & Inventario)'}
                            ...
                            {activeTab === 'facturas_correo' && 'Buzón de Facturas de Proveedores (Email)'}
                            {activeTab === 'conciliacion_datafono' && 'Conciliación de Datáfonos (Tarjetas)'}
                            {activeTab === 'caja_menor' && 'Legalización y Reembolso de Caja Menor'}
                        </p>
                    </div>
                </div>
            </header>
