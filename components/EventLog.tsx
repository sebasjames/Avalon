                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-3">
                                <GitCommit className="w-6 h-6 text-slate-700 rotate-90" />
                                Bitácora de Eventos (Event Log)
                            </h1>
                            <p className="text-slate-500 text-sm mt-1">Fuente de verdad forense. Registro inmutable de actividad humana, sistémica y decisiones de IA.</p>
                        </div>
