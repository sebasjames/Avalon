  ...
  return (
    <div className="p-6 space-y-6 bg-slate-50 min-h-screen">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">Torre de Control Operativo</h1>
        <p className="text-slate-500 mt-2">Visión en tiempo real de producción, inventario y rendimiento de ventas.</p>
      </header>
