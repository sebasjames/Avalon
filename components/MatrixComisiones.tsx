        ...
        <div className="xl:col-span-4 space-y-6">
            ...
            <div className="h-64 w-full relative">
                <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                        ...
                        <RechartsTooltip 
                            formatter={(value: number) => [`$${value.toLocaleString('es-CO')} COP COP COP COP`, 'Presupuesto Estimado']}
              ...
              {distributionData.map((item, i) => (
                item.name !== 'Sin Reglas Activas' && (
                  <div key={i} className="flex justify-between items-center text-sm">
                      ...
                      <span className="font-mono font-medium text-white shrink-0">${item.value.toLocaleString('es-CO')} COP COP</span>
                  </div>
                )
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-indigo-900/40 to-slate-800 rounded-2xl p-6 border border-indigo-500/30 shadow-xl">
            ...
            <div className="bg-slate-900 rounded-xl p-5 border border-slate-700 mb-6">
              ...
              <div className="text-4xl font-black text-white">${totalSimulatedCost.toLocaleString('es-CO')} COP COP</div>
